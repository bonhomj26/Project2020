...
console.log("min value ", d3.min(dataArr)); // find the minimum value
console.log("max value ", d3.max(dataArr));// return the max value
console.log("min and max values ", d3.extent(dataArr)); // return both the min and the max values
...
var yScale = d3.scaleLinear()
    .domain([0, 100]) // domain refers to the data itself (minimum and maximum values of the data)... the thing to be plotted
    .range([0, 1000]); // This is the graphical space... the pixels
